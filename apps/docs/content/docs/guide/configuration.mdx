...
This page shows common patterns for the authoring blocks: models, agents, Review Tasks, and Entrypoints. For the core model, see [Concepts](/docs/guide/concepts). For triggers and commands, see [Entrypoints](/docs/guide/entrypoints). For task handlers, see [Custom Tasks](/docs/guide/custom-tasks). For the full public API, see [Pipr SDK Reference](/docs/reference/sdk-reference). For generated starter configs, see [Init Recipes](/docs/recipes).
...
| Need | Use |
| --- | --- |
| One normal pull request review | `pipr.review(...)` |
