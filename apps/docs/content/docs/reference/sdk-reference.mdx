...
For the narrative model, see [Concepts](/docs/guide/concepts).
...
`pipr.reviewer(...)` creates the default structured pull request reviewer. `pipr.review(...)` wires that reviewer into change request and command entrypoints.
