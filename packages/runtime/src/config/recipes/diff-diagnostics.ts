...
export default definePipr((pipr) => {
  ...
  const diagnostics = pipr.agent({
    ...
    instructions: \`
      ...
      Omit suggestedFix when it is identical to the selected lines, only removes a trailing blank line, or only changes whitespace.
      The diagnostic body must describe the defect that suggestedFix directly fixes.
