...
export default definePipr((pipr) => {
  ...
  const hygiene = pipr.agent({
    ...
    instructions: \`
      ...
      that maintainers can act on in the changed lines. Include suggestedFix
      only for exact replacements that change the selected lines; omit it for
      no-op, trailing-blank-line-only, or whitespace-only changes. The finding
      body must describe the hygiene gap that suggestedFix directly fixes. Omit
      ...
      config key already present in the surrounding code.
    \`,
